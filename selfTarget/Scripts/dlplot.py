...
df = pd.read_csv("../../../Derived/selfTarget_run03_cho_3000/trial03_acc_stats.txt", header = None, sep = "\t")
df.columns = ["oligo_id", \
			"KL-Divergence", \
			"acc01_agr_1", \
			"acc02_agr_2", \
...
plt.text(0.54, 0.01, "n=3000".format(len(x)), style='italic')
plt.text(0.54, -0.025, "Pearson Correlation: {0}".format(round(corr,3)), style='italic')
plt.savefig("frameshift_mutations_CHO_FORECasT.png")
#plt.show()
#plt.close()
...
print(xrng)
data_actual = pd.read_csv("../../../Derived/selfTarget_run03_cho_3000/trial03_actual_mutation_frequencies.txt", header = 0, sep = "\t") #result_cho_trial03_3000.txt.freq_actual
data_pred = pd.read_csv("../../../Derived/selfTarget_run03_cho_3000/trial03_pred_mutation_frequencies.txt", header = 0, sep = "\t") #result_cho_trial03_3000.txt.freq_pred
...
#plt.savefig("trial03_mutation_frequencies_updated.png")
#plt.show()
